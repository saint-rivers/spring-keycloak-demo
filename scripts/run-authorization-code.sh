...
curl --location --request GET 'http://localhost:8800/auth/realms/cloud-server/protocol/openid-connect/auth?client_id=cloud-server-angular&response_type=code'

# get access_token using authorization_code
curl --location --request POST 'http://localhost:8800/auth/realms/cloud-server/protocol/openid-connect/token' \
  --header 'Content-Type: application/x-www-form-urlencoded' \
  --data-urlencode 'grant_type=authorization_code' \
  --data-urlencode 'client_id=cloud-server-angular' \
  --data-urlencode 'code=009c265d-27d2-47d3-8f09-dfff06317403.812986ea-b013-4609-a189-afb8b99e8bb8.ef08c246-1516-4930-b926-ef17ef0e9405' \
  --data-urlencode 'redirect_uri=http://localhost:8080/private' \
